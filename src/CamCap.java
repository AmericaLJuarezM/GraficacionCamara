...
public class CamCap extends javax.swing.JFrame {
    ...
    String File_path = "";
    String base_path = "C:\\Users\\sujet\\OneDrive\\Escritorio\\Tarea\\graficacion\\Graficacion-Camara-main\\Graficacion-Camara-main\\data\\haarcascades\\";//"C:\\Users\\mesa8\\OneDrive\\Documentos\\NetBeansProjects\\camcap\\data\\haarcascades\\";   // Carpeta donde se localizan los modelos de reconocimiento
                        ...
                        try {
                            ...
                            for (Rect rect : faceDetections.toArray()) {
                                ...
                                if (eyeDetections.toArray().length != 0) {
                                    ...
                                    System.out.println("Se detecta " + eyeDetections.toArray().length + " objeto(s)");
